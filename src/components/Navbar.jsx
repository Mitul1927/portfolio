...
const socialLinks = [
    { icon: <BsLinkedin />, href: "https://www.linkedin.com/in/mitul-dwivedi-5058b8253/", color: 'text-blue-300' },
    { icon: <BsGithub />, href: "https://github.com/Mitul1927", color: 'text-purple-500' },
    { icon: <SiLeetcode />, href: "https://leetcode.com/u/Mitul_Dwivedi/", color: 'text-green-500', title: "Download CV" }
